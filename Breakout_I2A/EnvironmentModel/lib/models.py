...
class EnvironmentModelVer2(nn.Module):
    def __init__(self,state_size,action_size):
        super(EnvironmentModelVer2, self).__init__()
...
class EnvironmentModelVer4(nn.Module):
    def __init__(self,state_size,action_size):
        super(EnvironmentModelVer4, self).__init__()
...
class EnvironmentModelVer5(nn.Module):
    def __init__(self,state_size,action_size):
        '''
        :param state_size:
        :param action_size:
         Ver 4에서 max_pool layer를 제거함
        '''
        super(EnvironmentModelVer5, self).__init__()
...
class EnvironmentModelVer6(nn.Module):
    def __init__(self,state_size,action_size):
        '''
        :param state_size:
        :param action_size:
         Ver 4에서 max_pool layer를 제거함
        '''
        super(EnvironmentModelVer6, self).__init__()
